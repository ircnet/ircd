 ...
 */
#define MODE_WPARAS (MODE_UNIQOP | MODE_CHANOP | MODE_VOICE | MODE_BAN | MODE_KEY | MODE_LIMIT | MODE_INVITE | MODE_EXCEPTION | MODE_REOPLIST)
/*
...
#define IsMember(u, c) (u && (u)->user &&                                        \
										find_channel_link((u)->user->channel, c) \
								? 1                                              \
								: 0)
